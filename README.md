...
|--------|---------|--------|
| `01_DeDuCE_integrate_attribution_layers_Global_Countries.R` | Global attribution (all countries) | GEE asset |
| `02_DeDuCE_export_spatial_allocation_areas_Global_Countries.R` | Calculate areas (Countries) | CSV: area ~ commodity × year × territory |
| `03_DeDuCE_integrate_attribution_layers_BR_States.R` | Brazil attribution (all states) | GEE asset |
| `04_DeDuCE_export_spatial_allocation_areas_BR_States.R` | Calculate areas (Brazil states) | CSV: area ~ commodity × year × territory |
